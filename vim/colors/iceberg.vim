...
if &background == 'light'
  hi Normal ctermbg=254 ctermfg=237 guibg=#eff9f7 guifg=#33374c
  ...
  hi CursorLine cterm=NONE ctermbg=253 ctermfg=NONE guibg=#c4c4c4 guifg=NONE
  ...
  hi Search ctermbg=216 ctermfg=234 guibg=#3e445e guifg=#ffffff
